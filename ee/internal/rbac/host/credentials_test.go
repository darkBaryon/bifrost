...
func TestProviderProxyCredentialDestination(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"overridden URL remains stored", &schemas.ProxyConfig{URL: schemas.NewSecretVar("http://fixture:synthetic@old.invalid")}, &schemas.ProxyConfig{URL: schemas.NewSecretVar("http://fixture:synthetic@new.invalid"), Username: schemas.NewSecretVar("fixture"), Password: schemas.NewSecretVar("new-fixture")}, true},
		{"schemeless override", &schemas.ProxyConfig{URL: schemas.NewSecretVar("fixture:synthetic@old.invalid:8080")}, &schemas.ProxyConfig{URL: schemas.NewSecretVar("fixture:synthetic@new.invalid:8080"), Username: schemas.NewSecretVar("fixture"), Password: schemas.NewSecretVar("new-fixture")}, true},
		{"remove stored URL authentication", &schemas.ProxyConfig{URL: schemas.NewSecretVar("http://fixture:synthetic@old.invalid")}, &schemas.ProxyConfig{URL: schemas.NewSecretVar("http://new.invalid"), Username: schemas.NewSecretVar("fixture"), Password: schemas.NewSecretVar("new-fixture")}, false},
		{"replace both stored credentials", &schemas.ProxyConfig{URL: schemas.NewSecretVar("http://fixture:synthetic@old.invalid"), Username: schemas.NewSecretVar("fixture"), Password: schemas.NewSecretVar("old-explicit")}, &schemas.ProxyConfig{URL: schemas.NewSecretVar("http://fixture:new-url-fixture@new.invalid"), Username: schemas.NewSecretVar("fixture"), Password: schemas.NewSecretVar("new-fixture")}, false},
		{"inactive environment URL", &schemas.ProxyConfig{Type: schemas.EnvProxy, URL: schemas.NewSecretVar("http://fixture:synthetic@proxy.invalid")}, &schemas.ProxyConfig{Type: schemas.HTTPProxy, URL: schemas.NewSecretVar("http://fixture:synthetic@proxy.invalid")}, true},
